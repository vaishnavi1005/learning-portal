...
public static void main(String[] args) {
	...
	boolean ishavingAccess = client.checkAndAccessGateUsingIdCard(employee2);
	...
	boolean ishavingAccessForManoj = client.checkAndAccessGateUsingIdCard(manoj);
	...
	//Outside provider 
	public  boolean checkAndAccessGateUsingIdCard(Employee employee) {
